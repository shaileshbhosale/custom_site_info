...
/**
 * @file
 * Contains \Drupal\custom_site_info\Controller\ShowPageJson.
 */
...
class ShowPageJson {
    public function NodeAccess($site_api_key, NodeInterface $node){
        ...
        // Check if node id provided in url is of type page, the configuration key is saved and matches with provided key in url
